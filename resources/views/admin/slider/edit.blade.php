    ...
    <section class="content">
        <div class="box box-default color-palette-box ">
            ...
            <div class="box-body">
                ...
                <form method="POST"  action="{{action('SliderController@update', $slider)}}" enctype="multipart/form-data">
                    ...
                    <div class="box-body col-md-10 col-sm-offset-1">
                        ...
                        <div class="form-group {{ $errors->has('titleAr') ? ' has-error' : '' }}">
                            ...
                            <input type="text" id="myname_ar" name="titleAr" class="form-control"  value="{{$slider->titleAr}}" />
                        ...
                        <div class="form-group {{ $errors->has('titleEn') ? ' has-error' : '' }}">
                            ...
                            <input type="text" id="myname_en" name="titleEn" class="form-control" value="{{$slider->titleEn}}" />
                        ...
                        <div class="form-group {{ $errors->has('textAr') ? ' has-error' : '' }}">
                            ...
                            <textarea class="textarea" name="textAr"
                                      style="width: 100%; height: 150px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$slider->textAr}}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('textEn') ? ' has-error' : '' }}">
                            ...
                            <textarea class="textarea" name="textEn"
                                      style="width: 100%; height: 150px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$slider->textEn}}</textarea>
