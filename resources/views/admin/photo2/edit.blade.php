    ...
    <section class="content">
        <div class="box box-default color-palette-box ">
            ...
            <div class="box-body">
                ...
                <form method="POST"  action="{{action('Photo2Controller@update', $photo2->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="box-body col-md-10 col-sm-offset-1">
                        ...
                        <div class="form-group {{ $errors->has('img') ? ' has-error' : '' }}">
                            ...
                            <img class="card-img-top" src="{{ asset('imgs/' . $photo2->img) }} " style="width:150px;height:150px;" >
