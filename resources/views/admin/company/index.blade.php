        ...
        <div class="box-default color-palette-box">
            <div class="box">
                <div class="box-header with-border">
                    <a href="/admin/company/create" type="button" class="btn btn-info pull-right">@lang('lang.Additem')</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table class="table table-bordered text-center">
                        ...
                        @foreach($items as $item)
                            <tr>
                                ...
                                <td>{{ $item->titleAr}}</td>
                                <td>{{ $item->titleEn}}</td>
                                <td> <img class="card-img-top" src="{{ asset('imgs/' . $item->img) }} " style="width: 50px;height: 50px;" >

                                <td>
                                    <a href="company/{{ $item->id}}/edit" type="button" class="btn btn-info">@lang('lang.Edit')</a>
                                    <a class="btn">
