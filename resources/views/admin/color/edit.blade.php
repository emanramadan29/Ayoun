    ...
    <section class="content">
        <div class="box box-default color-palette-box ">
            ...
            <div class="box-body">
                ...
                <form method="POST"  action="{{action('ColorController@update', $item->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="box-body col-md-10 col-sm-offset-1">
                        ...
                        <div class="form-group {{ $errors->has('color') ? ' has-error' : '' }}">
                            ...
                            <input type="color" id="color" name="color" style="width: 200px;" class="form-control" value="{{$item->color}}" />
