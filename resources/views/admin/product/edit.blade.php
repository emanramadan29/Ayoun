    ...
    <section class="content">
        <div class="box box-default color-palette-box ">
            ...
            <div class="box-body">
                ...
                <form method="POST"  action="{{action('ProductController@update', $item->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group center">
                        <div class="col-md-offset-2 col-md-4">
                            <a href="/admin/product" class="btn btn-block btn-danger" role="button">@lang('lang.Cancel')</a>
                        </div>
                        <div class="col-md-4">
