        ...
        <div class="box-default color-palette-box">
            <div class="box">
                <div class="box-header with-border">
                    <a href="/admin/product/create" type="button" class="btn btn-info pull-right">@lang('lang.Additem')</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table class="table table-bordered text-center">
                        ...
                        @foreach($items as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="product/{{ $item->id}}/edit" type="button" class="btn btn-info">@lang('lang.Edit')</a>
                                    <a class="btn">
